...
#define VTENC_SET_MAX_VALUES_U8         BITS_POS_MASK64[VTENC_SET_CARDINALITY_SIZE_U8]
#define VTENC_SET_CARDINALITY_SIZE_U16  MIN(16, BIT_STREAM_MAX_WRITE)
#define VTENC_SET_MAX_VALUES_U16        BITS_POS_MASK64[VTENC_SET_CARDINALITY_SIZE_U16]
#define VTENC_SET_CARDINALITY_SIZE_U32  MIN(32, BIT_STREAM_MAX_WRITE)
#define VTENC_SET_MAX_VALUES_U32        BITS_POS_MASK64[VTENC_SET_CARDINALITY_SIZE_U32]
#define VTENC_SET_CARDINALITY_SIZE_U64  MIN(64, BIT_STREAM_MAX_WRITE)
#define VTENC_SET_MAX_VALUES_U64        BITS_POS_MASK64[VTENC_SET_CARDINALITY_SIZE_U64]
