...
int main()
{
  ...
  RUN_TEST(test_vtenc_set_encode_u16_5);
  ...
  RUN_TEST(test_vtenc_list_decode_u8_6);
  ...
  RUN_TEST(test_vtenc_list_decode_u16_6);
  ...
  RUN_TEST(test_vtenc_list_decode_u32_6);
  ...
  RUN_TEST(test_vtenc_list_decode_u64_6);
  ...
  RUN_TEST(test_vtenc_set_decode_u8_6);
  ...
  RUN_TEST(test_vtenc_set_decode_u16_5);
  ...
  RUN_TEST(test_vtenc_set_decode_u32_5);
  ...
  RUN_TEST(test_vtenc_set_decode_u64_6);
